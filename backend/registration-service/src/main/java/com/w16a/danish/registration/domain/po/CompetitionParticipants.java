 ...
 * @author Eddy ZHANG
 * @date 2025/04/03
 * @description Table for mapping participants to competitions (many-to-many relationship)
 */
@Data
...
public class CompetitionParticipants implements Serializable {
    ...
    @Schema(description = "Timestamp when the participant registered for the competition", example = "2025-04-03T12:00:00")
    @TableField(fill = FieldFill.INSERT)
    private LocalDateTime createdAt;

    @Schema(description = "Timestamp when the record was last updated", example = "2025-04-03T14:30:00")
