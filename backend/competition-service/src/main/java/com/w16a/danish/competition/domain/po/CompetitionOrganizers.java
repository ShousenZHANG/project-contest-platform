 ...
 * @author Eddy ZHANG
 * @date 2025/03/18
 * @description Table for competition organizers (many-to-many relationship)
 */
@Data
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@TableName("competition_organizers")
@Schema(name = "CompetitionOrganizers", description = "Table for mapping organizers to competitions (many-to-many relationship)")
public class CompetitionOrganizers implements Serializable {
    ...
    @Schema(description = "Organizer user ID (UUID)", example = "xyz123-lmn456-opq789-rst012")
    private String userId;

    @Schema(description = "Timestamp when the organizer was assigned to the competition", example = "2025-03-18T12:00:00")
